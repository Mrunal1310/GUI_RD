...
class RoundTripprinting:
    ...
    def __init__(self, root):
        ...
        self.round_trip_print.title("Print sound")
    ...
    def title_frame(self):
        ...
        self.label=ctk.CTkLabel(self.frame, text="Print sound",  fg_color="#A83232", corner_radius=0, anchor='center',text_color="white",font=("Aerial", 20, 'bold'))
