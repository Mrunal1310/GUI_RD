...
select_alarm.geometry("1200x800+700+200")
select_alarm.resizable(True, True)
#select_alarm.maxsize(height=500, width=500)
#select_alarm.minsize(height=300, width=300)
