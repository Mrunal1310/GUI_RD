...
class MultiFrameCache:
    ...
    def title_frame(self):
        ...
        self.label=ctk.CTkLabel(self.frame, text="Multi frame cache",  fg_color="#A83232", corner_radius=0, anchor='center',text_color="white",font=("Aerial", 20, 'bold'))
        ...
        try:
            ...
            self.close_button=ctk.CTkButton(self.frame, text="",anchor="center", image=image, command=self.multi_frame_cache.destroy, hover_color="#A83232", fg_color="#A83232",bg_color="#A83232",width=50, height=20, corner_radius=0)
            self.close_button.grid(row=0, column=0,sticky='e')
            image.close()
        except FileNotFoundError:
            print(f"Error: Image not found at {image_path}")
            self.close_button=ctk.CTkButton(self.frame, text="X",anchor="center", command=self.multi_frame_cache.destroy, hover_color="#A83232", fg_color="#A83232",bg_color="#A83232",width=50, height=20, corner_radius=0)
            self.close_button.grid(row=0, column=0, sticky='e')
