...
class GrayscaleWindow:
    def __init__(self, app):
        ...
        # Create buttons dynamically using a dictionary and for loop
        self.create_buttons()
    ...
    def create_title(self):
        ...
        image_close = ctk.CTkImage(dark_image=Image.open("close.png"), size=(20, 20))  # Update image path if needed
        ...
        label1 = ctk.CTkLabel(frame1, text="Grayscale", fg_color="#A83232", corner_radius=0, anchor='center', text_color="white", font=("aerial", 20, 'bold'))
    ...
    def create_buttons(self):
        ...
        button_config = {
            ...
            "double": {"text": "Double"},
            "fourfold": {"text": "Fourfold"},
            "six_times": {"text": "Six times"},
            "eight_times": {"text": "Eight times"},
            "bold": {"text": "Bold"},
            "triple": {"text": "Triple"},
            "five_times": {"text": "Five times"},
            "seven_times": {"text": "Seven times"},
            "nine_times": {"text": "Nine times"}
        }

        # Create buttons dynamically from dictionary using a loop
        for idx, (key, config) in enumerate(button_config.items()):
            button = ctk.CTkButton(frame2, text=config["text"],
                                   corner_radius=0, 
                                   width=400, height=40,
                                   fg_color="#FF00FF", 
                                   hover_color="pink", 
