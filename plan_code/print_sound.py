...
frame1.columnconfigure((0, 1, 2), weight=2)
...
# Create a checkbox
checkbox = ctk.CTkCheckBox(frame2, text="External alarm", corner_radius=0, border_width=2, text_color= "black", font=("aerial", 25,), bg_color="white", command=on_checkbox_change)
checkbox.grid(row=4, column=0, padx=10, pady=15, sticky="we")
